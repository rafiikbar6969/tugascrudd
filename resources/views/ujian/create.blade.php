        ...
        <div class="col-8 mt-3">
            ...
            <form method="POST" action="/ujian">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('nama_mk') is-invalid @enderror" id="nama_mk" placeholder="Masukkan Nama Mata Kuliah" name="nama_mk" value="{{old('nama_mk')}}">
                    @error('nama_mk') <div id="validationServer03Feedback" class="invalid-feedback">{{$message}}</div> @enderror
                </div>
                <div class="mb-3">
                    <label for="dosen">Dosen</label>
                    <input type="text" class="form-control @error('dosen') is-invalid @enderror" id="dosen" placeholder="Masukkan Nama Dosen" name="dosen" value="{{old('dosen')}}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('jml_Soal') is-invalid @enderror" id="jml_Soal" placeholder="Masukkan Jumlah Soal" name="jml_Soal" value="{{old('jml_Soal')}}">
